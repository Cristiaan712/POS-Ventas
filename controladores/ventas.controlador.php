	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
				...
				$printer -> text("Market Tasty"."\n");//Nombre de la empresa

				$printer -> text("RUC: 71.759.963-9"."\n");//RUC de la empresa

				$printer -> text("Dirección: Av. Brasil 1029 - Jesús María"."\n");//Dirección de la empresa

				$printer -> text("Teléfono: 961-715-328"."\n");//Teléfono de la empresa

				$printer -> text("N° TICKET:".$_POST["nuevaVenta"]."\n");//Número de factura
				...
				$printer->text("IGV: S/. ".number_format($_POST["nuevoPrecioImpuesto"],2)."\n"); //ahora va el impuesto
			...
			foreach ($ventas as $row => $item){
			 ...
			 echo utf8_decode("<tr>
				...
				foreach ($productos as $key => $valueProductos ) {
					...
					echo "S/". utf8_decode(number_format($valueProductos["precio"], 2) . "<br>");
				}
