      	...
      	success:function(respuesta){
	          ...
	          '<div class="col-xs-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<span class="input-group-addon"><button type="button" class="btn btn-danger btn-block btn-xs quitarProducto" idProducto="'+idProducto+'"><i class="fa fa-times"></i></button></span>'+
      	...
      	success:function(respuesta){
	          ...
	          '<div class="col-xs-3 ingresoPrecio" style="padding-left:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<span class="input-group-addon"><i class="ion ion-social"></i></span>'+
		...
		$(this).parent().parent().parent().children(".cajasMetodoPago").html(
			 ...
			 '<div class="col-xs-4">'+ 
			 	...
			 	'<div class="input-group">'+ 
			 		...
			 		'<input type="text" class="form-control" id="nuevoValorEfectivo" placeholder="Cancela con:" required>'+
